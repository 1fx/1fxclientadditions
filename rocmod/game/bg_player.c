...
{
#ifdef SMKWEAPONS
	{ MODELINDEX_WEAPON_AK74,		MODELINDEX_WEAPON_M4,		MODELINDEX_WEAPON_SIG551,	MODELINDEX_WEAPON_OICW,	MODELINDEX_WEAPON_USAS12, MODELINDEX_WEAPON_MSG90A1,	MODELINDEX_WEAPON_M60,	MODELINDEX_WEAPON_MP5,	MODELINDEX_WEAPON_RPG7,	 MODELINDEX_WEAPON_MM1, -1, -1 },
#else
...
qboolean BG_ParseNPCFiles ( void )
{
	...
	// For some unfathomable reason, the list of NPC files that are about to be
	// parsed are unsorted. So, in order to guarantee that our new NPC file is
	// parsed AFTER all of the existing files, we are going to manually add it
	...
	Q_strncpyz( fileptr, "roc_females.npc2", NPCFiles+sizeof(NPCFiles)-fileptr );
	numNPCFiles++;
...
=================
*/
#define MAX_TEAM_IDENTS	6 // 5 pimpy
