...
# *** Client ui module compilation script ***
#
# This script allows you to compile the client ui module as DLL, for WIN32,
...
#
# --- Boe!Man 3/27/20 - 9:05 PM

# Enable aliases.
shopt -s expand_aliases

# The compile options relevant for all builds are noted here.
buildoptions="-O2 -D_USRDLL -DWIN32 -D_WINDOWS -DUI_EXPORTS -D_SOF2 -DCURL_STATICLIB -DPTW32_STATIC_LIB"
...
cFileCount=`ls -l *.c ../game/bg_gametype.c ../game/bg_lib.c ../game/bg_misc.c ../game/bg_player.c ../game/bg_weapons.c ../game/q_*.c | wc -l`
# Remove whitespace.
...
for cFile in *.c ../game/bg_gametype.c ../game/bg_lib.c ../game/bg_misc.c ../game/bg_player.c ../game/bg_weapons.c ../game/q_*.c
do
...
$linker $m32b $strip -shared $linkfiles -static -static-libgcc -lcurl -lcrypto -lpthread -lws2_32 -lwldap32 -lshlwapi -o $outfile 2>> compile_log
