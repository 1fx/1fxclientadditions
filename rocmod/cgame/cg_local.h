...
//	snapshot_t		activeSnapshots[2];
	...
	int				bestAccuracy;
	int				bestRatio;
	int				bestFlagCaps;		// used for briefcase as well
	int				bestFlagDefends;	// used for briefcase as well
	int				bestValue;
	int				bestKillRate;
	int				bestKillSpree;
	int				bestNadeKills;
	...
	int					updateTimer;		// Once a second

	playerNames_t		playerNames[MAX_CLIENTS];
...
//	qhandle_t	balloonShader;
	qhandle_t	dummyShader;

	qhandle_t	hudcolShader;
	qhandle_t	hudwpShader;

	qhandle_t	radarShader;
	qhandle_t	radar2Shader;

	qhandle_t	botSmallShader;

	qhandle_t	crosshairShader[NUM_CROSSHAIRS];
	qhandle_t	lagometerShader;
	qhandle_t	lagometer2Shader;
...
typedef struct
{
	...
	qboolean		screenshotTaken;
	int				demoRunning;
	int				demoTime;
	qboolean		demoRequested;
...
extern	vmCvar_t		cg_drawBestStats;
extern	vmCvar_t		cg_drawEnhancedHUD;
extern	vmCvar_t		cg_drawEnhancedScoreboard;
extern  vmCvar_t		cg_drawNumericHealth; // 01/21/05 pimpy for hud2 right now
extern	vmCvar_t		cg_allowVoiceCommandSounds;
extern	vmCvar_t		cg_realisticSniper;
extern	vmCvar_t		cg_drawDetailedObituary;
extern	vmCvar_t		cg_drawTeamInfo;
extern	vmCvar_t		cg_drawSpecList;
extern	vmCvar_t		cg_drawTimeLeft;
extern	vmCvar_t		cg_drawTeamOverlay;
extern	vmCvar_t		cg_customBlueName;
extern	vmCvar_t		cg_customBlueCode;
extern	vmCvar_t		cg_customBlueShade;
extern	vmCvar_t		cg_customRedName;
extern	vmCvar_t		cg_customRedCode;
extern	vmCvar_t		cg_customRedShade;
extern	vmCvar_t		cg_customClanShade;
extern	vmCvar_t		cg_allowCustomTeams;
