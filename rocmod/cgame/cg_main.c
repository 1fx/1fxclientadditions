...
vmCvar_t	cg_drawEnhancedHUD;
vmCvar_t	cg_drawEnhancedScoreboard;
vmCvar_t	cg_drawNumericHealth; // 01/21/05 pimpy
vmCvar_t	cg_allowVoiceCommandSounds;
vmCvar_t	cg_realisticSniper;
vmCvar_t	cg_drawDetailedObituary;
vmCvar_t	cg_drawTeamInfo;
vmCvar_t	cg_drawSpecList;
vmCvar_t	cg_drawTimeLeft;

vmCvar_t	g_realisticAmmo;
vmCvar_t	g_weaponMod;
vmCvar_t	cg_drawTeamOverlay;
vmCvar_t	cg_customBlueName;
vmCvar_t	cg_customBlueCode;
vmCvar_t	cg_customBlueShade;
vmCvar_t	cg_customRedName;
vmCvar_t	cg_customRedCode;
vmCvar_t	cg_customRedShade;
vmCvar_t	cg_customClanShade;
vmCvar_t	cg_allowCustomTeams;
...
static cvarTable_t cvarTable[] =
{
	...
	{ &cg_hudFiles, "cg_hudFiles", "ui/rochud.txt", CVAR_ARCHIVE},
	...
	{ &cg_drawBestStats, "cg_drawBestStats", "1", CVAR_ARCHIVE  },
	{ &cg_drawEnhancedHUD, "cg_drawEnhancedHUD", "2", CVAR_ARCHIVE  },
	{ &cg_drawEnhancedScoreboard, "cg_drawEnhancedScoreboard", "1", CVAR_ARCHIVE  },
	{ &cg_allowVoiceCommandSounds, "cg_allowVoiceCommandSounds", "1", CVAR_ARCHIVE  },
	{ &cg_drawNumericHealth, "cg_drawNumericHealth", "0", CVAR_ARCHIVE }, // 01/21/05 pimpy
	{ &cg_realisticSniper, "g_realisticSniper", "1", 0 },
	{ &cg_drawDetailedObituary, "cg_drawDetailedObituary", "1", CVAR_ARCHIVE  },
	{ &cg_drawTeamInfo, "cg_drawTeamInfo", "0", CVAR_ARCHIVE  },
	{ &cg_drawSpecList, "cg_drawSpecList", "0", CVAR_ARCHIVE  },
	{ &cg_drawTimeLeft, "cg_drawTimeLeft", "0", CVAR_ARCHIVE  },
	{ &g_weaponMod, "g_weaponMod", "ext_data/sof2.wpn", 0 },
	{ &g_realisticAmmo, "g_realisticAmmo", "0", 0 },
	{ &cg_drawTeamOverlay, "cg_drawTeamOverlay", "0", CVAR_ARCHIVE  },
	{ &cg_customBlueName, "g_customBlueName", "Blue", 0 },
	{ &cg_customBlueCode, "g_customBlueCode", "4", 0 },
	{ &cg_customBlueShade, "g_customBlueShade", "30,30,100", 0 },
	{ &cg_customRedName, "g_customRedName", "Red", 0 },
	{ &cg_customRedCode, "g_customRedCode", "1", 0 },
	{ &cg_customRedShade, "g_customRedShade", "100,10,10", 0 },
	{ &cg_customClanShade, "g_customClanShade", "100,50,0", 0 },
	{ &cg_allowCustomTeams, "g_allowCustomTeams", "0", 0 },
	{ &inMatch, "inMatch", "0", 0 },
	{ &exitReady, "exitReady", "0", 0 },
	{ &cg_autoScreenshot, "cg_autoScreenshot", "1", CVAR_ARCHIVE  },
	{ &cg_autoDemo, "cg_autoDemo", "1", CVAR_ARCHIVE  },
	{ &g_anonymousAdmin, "g_anonymousAdmin", "0", 0 },
};
...
static void CG_RegisterSounds( void )
{
	...
	cgs.media.admintalkSound = trap_S_RegisterSound( "sound/misc/menus/quit_request");
...
static void CG_RegisterGraphics( void )
{
	...
	cgs.media.lagometer2Shader = trap_R_RegisterShaderNoMip("gfx/menus/hud/roc-lagometer.png" );
	...
	if ( cgs.gametypeData->teams )
	{
		...
		cgs.media.radar2Shader	   = trap_R_RegisterShaderNoMip ( "gfx/menus/hud/roc-radar.png" );
	}

//	cgs.media.balloonShader = trap_R_RegisterShader ( "gfx/menus/hud/chat" );
	cgs.media.dummyShader   = trap_R_RegisterShader ( "gfx/menus/hud/dummy" );

	cgs.media.hudcolShader   = trap_R_RegisterShaderNoMip ( "gfx/menus/hud/roc-hudcol.png" );
	cgs.media.hudwpShader    = trap_R_RegisterShaderNoMip ( "gfx/menus/hud/roc-hudwp.png" );
...
void CG_LoadMenus ( const char *menuFile )
{
	...
	if ( !f )
	{
		Com_Error( ERR_FATAL, va( S_COLOR_RED "hud menu file not found: ui/%s, unable to continue!\n", menuFile ) );
		return;
	}
